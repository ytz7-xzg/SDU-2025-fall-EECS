...
RIGHT_DISTANCE_CHANGE_THRESHOLD = 0.1
...
class MySMClass(sm.SM):
    ...
    def getNextValues(self, state, inp):
        ...
        if state == 'DrivingForward':
            ...
            if front_distance < FRONT_OBSTACLE_THRESHOLD or min(sonars[6],sonars[7]) < 0.25:
            ...
            if front_distance < FRONT_OBSTACLE_THRESHOLD * 1.5:
                ...
                next_state = 'TurningOuterCorner'
                fvel = FORWARD_SPEED * 0.5
                rvel = -TURN_SPEED_LIGHT * 7
